...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected Paint mDescMA10Paint;
    protected Paint mDescMA30Paint;
    ...
    protected void init() {
        ...
        mDescMA10Paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDescMA30Paint = new Paint(Paint.ANTI_ALIAS_FLAG);
